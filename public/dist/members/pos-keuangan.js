var Index = (function () {
    ...
    var table;
    var aSelected = [];
    const nameOfModule = "pos-keuangan";
    ...
    var handleDataTable = function () {
        table = $("#table-" + nameOfModule).DataTable({
            ...
            serverSide: true,
            ajax: {
                url: url + "/members/pos-keuangan/list",
                type: "POST",
                data: {
                    _token: csrf_token,
                },
    ...
    var handleSubmit = function () {
        $("#form-add-" + nameOfModule).submit(function (e) {
            ...
            $.ajax({
                url: `${url}/members/pos-keuangan/save`,
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
    ...
    var handleEdit = function () {
        $(document).on("click", ".btn-edit", function () {
            ...
            $.ajax({
                type: "POST",
                url: `${url}/members/pos-keuangan/edit`,
                data: {
                    _token: csrf_token,
                    btnx: dataBtn,
                },
                ...
                success: function (response) {
                    ...
                    $("#post-name-edit").val(dataResponse.post_name);
    ...
    var handleUpdate = function (xv) {
        $("#form-edit-" + nameOfModule).submit(function (e) {
            ...
            $.ajax({
                url: `${url}/members/pos-keuangan/update`,
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
        ...
        $("#btn-delete").click(function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: url + "/members/pos-keuangan/delete",
                        data: {
                            _token: csrf_token,
                            x_data: aSelected,
                        },
