var Index = (function () {
    ...
    var table;
    var aSelected = [];
    const nameOfModule = "category-transaction";
    ...
    var handleDataTable = function () {
        table = $("#table-" + nameOfModule).DataTable({
            ...
            serverSide: true,
            ajax: {
                url: url + "/admin/category-transaction/list",
                type: "POST",
                data: {
                    _token: csrf_token,
                },
    ...
    var handleSubmit = function () {
        $("#form-add-" + nameOfModule).submit(function (e) {
            ...
            $.ajax({
                url: `${url}/admin/category-transaction/save`,
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
    ...
    var handleEdit = function () {
        $(document).on("click", ".btn-edit", function () {
            const dataBtn = $(this).data("btn");
            $.ajax({
                type: "POST",
                url: `${url}/admin/category-transaction/edit`,
                data: {
                    _token: csrf_token,
                    btnx: dataBtn,
                },
                ...
                success: function (response) {
                    ...
                    $("#category-name-edit").val(dataResponse.category_name);
                    handleUpdate(dataResponse.data_x);
                },
                error: function (response) {
    ...
    var handleUpdate = function (xv) {
        $("#form-update-" + nameOfModule).submit(function (e) {
            e.preventDefault();
            const form = $(this);
            let formData = new FormData(form[0]);
            ...
            $.ajax({
                url: `${url}/admin/category-transaction/update`,
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
        ...
        $("#btn-delete").click(function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: url + "/admin/category-transaction/delete",
                        data: {
                            _token: csrf_token,
                            x_data: aSelected,
                        },
