...
@section('app_content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="m-0">Members > Masjid Management</h3>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button id="btn-add" class="btn btn-sm btn-primary" data-toggle="modal"
                                data-target="#modal-add-masjid">Registrasi masjid</button>
                            <button id="btn-delete" class="btn btn-sm btn-danger">Delete data</button>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped" id="table-masjid-management">
                                <thead>
                                    <tr>
    ...
    <!-- modal add data -->
    <div class="modal fade" id="modal-add-masjid" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Modal registrasi masjid</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="javascript:;" method="post" id="form-add-masjid-management"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <label for="">Masjid name</label>
                                <input type="text" name="name" id="masjid-name" class="form-control">
                                <label for="">Phone</label>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <label for="">Address</label>
                                <textarea id="address" name="address" cols="30" class="form-control" rows="7"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
    ...
    <!-- modal edit data -->
    <div class="modal fade" id="modal-edit-masjid" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Modal edit masjid</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="javascript:;" method="post" id="form-edit-masjid-management"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <label for="">Masjid name</label>
                                <input type="text" name="name" id="masjid-name-edit" class="form-control">
                                <label for="">Phone</label>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <label for="">Address</label>
                                <textarea id="address-edit" name="address" cols="30" class="form-control" rows="7"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <img src="" alt="" style="width: 250px; height:250px;"
                                    id="masjid-image-edit" class="form-control img-fluid">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
...
@push('app_scripts')
    ...
    <script src="{{ asset('dist/members/masjid-management.min.js?qwd=') . time() }}"></script>
@endpush
